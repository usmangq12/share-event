                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-4">
                    ...
                    <select
                      ...
                      className=" block w-full mt-2 rounded-md border border-gray-300 bg-white py-2 px-3  focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                    >
